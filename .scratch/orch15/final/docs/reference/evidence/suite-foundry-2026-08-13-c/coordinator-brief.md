# SUITE-FOUNDRY wave-c COORDINATOR BRIEF — verify the five red-first suites (v4-pro seat)
...
content is ground truth; silence is not death). Five rows are writing red-first suites: #155
