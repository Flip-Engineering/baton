...
Wave: death-certs-2026-08-15-wave-h
VERDICT: needs-fold with blockers
Scope: docs/reference/evidence/death-certs-2026-08-15/wave-h/**
...
- **E1 — Working tree clean at the coordinator base.** `git status` is empty; HEAD is
  ...
  baton workflow base phantom-root-2026-08-15-wave-h`), never on this worktree's branch.
- **E2 — Row notes absent.** The required
  `docs/reference/evidence/death-certs-2026-08-15/wave-h/notes-row-death-certs.md` (harvest
