# COORDINATOR BRIEF — readme-split wave

One row works under you: row-readme (its brief names the contract: the README split brief (docs acceptance)). You receive
...
3. Write verify-notes.md (this dir): VERDICT (sound / needs-fold with blockers), the measured
   counts, anything not green and why. Line 1: README_SPLIT-VERIFY v1. [attempt:] line verbatim
