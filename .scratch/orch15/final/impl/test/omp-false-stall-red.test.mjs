...
test('OMP-FALSE-STALL: a live omp turn (steer-nudged, mid-tool-call) is never declared stalled', async () => {
  ...
  // Native steering belongs to the completed run. Baton must not replay a queued steer as
  // another provider prompt merely because the native session reached its checkpoint.
