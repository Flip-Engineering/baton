# ROW BRIEF — row-suite-159: the red-first suite for the folded #159 contract
...
`docs/reference/evidence/doc-truth-conformance-2026-08-13/contract-fold.md` (v1.1 — its red-first acceptance section is
...
Deliverables (edit ONLY these): `impl/test/doc-truth-conformance-red.test.mjs` ·
`docs/reference/evidence/doc-truth-conformance-2026-08-13/suite-draft-notes.md` (the row inventory + stage table + the
