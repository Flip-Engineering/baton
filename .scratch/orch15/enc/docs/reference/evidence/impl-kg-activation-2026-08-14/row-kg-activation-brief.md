...
`docs/reference/evidence/impl-kg-activation-2026-08-14/**`. (The store file is shared with
...
`docs/reference/evidence/impl-kg-activation-2026-08-14/notes-row-kg-activation.md` —
