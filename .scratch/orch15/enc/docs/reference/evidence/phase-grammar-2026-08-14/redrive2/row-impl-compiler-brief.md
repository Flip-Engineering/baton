...
`impl/src/workflow-dsl.mjs` ONLY, plus `docs/reference/evidence/phase-grammar-2026-08-14/redrive2/**`.
...
Deliverable note: `docs/reference/evidence/phase-grammar-2026-08-14/redrive2/impl-compiler-notes.md` —
