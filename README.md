...
- `docs/48-reincarnation-in-place.md` — resident reincarnation in place (#306): the incarnation model, the nine-step handoff protocol with a durable row per step and a crash table, what survives and what drains, refusals, `incarnation_changed`.
