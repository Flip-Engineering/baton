...
terminal failed-generation settlement, retained-result capsule projection/materialization, and
atomic accepted-child attachment now ship. Next bind Workflow definition v3 and exact role
templates; introduce generic request/call/unit authority while keeping the Phase 84 adapter; add
