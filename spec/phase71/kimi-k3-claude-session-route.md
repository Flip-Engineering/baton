...
switches, tool-search/compaction/effort variables, and especially `ANTHROPIC_API_KEY` before adding
the closed Kimi set. Undocumented compatibility variables are not invented merely because an old
cleanup guide names them.
