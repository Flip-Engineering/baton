...
| Cairn causal integrity and attested audit/trace | Memory/Trust/Operate | Phase 47 implementation gate shipped locally; true bitemporal observation history, content-bound generic graph events, typed live causal audit, explicit contradiction CAS/resolution/contamination, bounded live trace, repository/transport-bound ACI, and a digested full-goal retention catalog; recursive provider proof is the next gate | `spec/phase47/cairn-causal-integrity-audit.md`, `impl/test/phase47-cairn-causal-audit.test.mjs` |
