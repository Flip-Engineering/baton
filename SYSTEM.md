...
| Advisory refresh guard + exact TTL invalidation | Safety/Memory | Shipped Phase 39; provider push/clearance later | `spec/phase39/advisory-ttl-invalidation.md`, `docs/capabilities/orientation-reuse.md` |
