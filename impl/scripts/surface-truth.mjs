...
//
// Every list here is re-derived at import time from the same src tables, so a surface change
// lands here by construction and no committed snapshot feeds it.
