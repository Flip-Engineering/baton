# System Validation — living full-system ledger through Phase 49
...
Cairn causal integrity/audit/trace, audit-gated bounded recall, and audit-gated selective promotion.
...
|---|---|
| Canonical zero-quota suite | **1005/1005 passing** via `npm test` in `impl/`; its lifecycle owner reaps the private suite root, and the real linked-worktree regression covers recursive Baton execution without relying on a directory-shaped `.git` |
