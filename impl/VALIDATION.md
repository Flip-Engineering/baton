...
| Atlas index/symbol/SCIP | `docs/handoff/evidence/phase13-atlas-index-symbols-2026-07-11.md`; 8 focused contracts plus the 575/575 full suite cover immutable explicit epochs, base-plus-worktree overlay reconciliation/staleness, lexical/repo-map/code-seed orientation, parsed symbol/reference/call graphs, SCIP JSON artifacts, bounded resumable output, cancellation/confinement, typed ambiguity, deterministic reverify, and a live 74-document Baton self-index; live LSP, structural rewrite, semantic/CPG/IR/merge rungs remain explicit |
