...
|---|---|
| Zero-quota suite | **509/509 passing** via bare `node --test` in `impl/` |
...
| Coordination foundation | `docs/handoff/evidence/phase11-coordination-foundation-2026-07-11.md`; CK1/CK2 stream, CAS, and queued-DAG replay are green; later CK contracts remain active |
