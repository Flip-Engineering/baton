...
8. **Atlas and representation depth.** The real AST/CST structural-delta and proposal-only
   ...
   node/edge delta, bounded impact, and operator-specified lexical taint witnesses now also ship;
   direct rewrite apply, full rule configs, live LSP, semantic retrieval, full path-sensitive CPG/PDG/dataflow/taint,
