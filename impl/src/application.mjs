...
import * as applicationAdmission from './application-admission.mjs';
import {
  MAX_REVIEW_SOURCE_BYTES,
  contentDigest,
  explicitResultIntentIdentity,
  normalizeIntent,
  routeEqual,
  routeNotAllowedRefusal,
  semanticSourceSlice,
  workflowFeedbackBodySetDigest,
} from './application-admission.mjs';
...
export class BatonApplication {
  ...
  _resolveSemanticControlTarget(current, recipient, operation) {
    return applicationAdmission._resolveSemanticControlTarget(this, current, recipient, operation);
  }
  ...
  _normalizeRunControlOutcome(outcome, schemaVersion = 2) {
    return applicationAdmission._normalizeRunControlOutcome(this, outcome, schemaVersion);
  }
  ...
  _resolveIntent(rawIntent) {
    return applicationAdmission._resolveIntent(this, rawIntent);
  }
  ...
  _admitWorkspaceAttachment(runId, workspace) {
    return applicationAdmission._admitWorkspaceAttachment(this, runId, workspace);
  }
  ...
  _resolveSpillObjective(objective) {
    return applicationAdmission._resolveSpillObjective(this, objective);
  }
  ...
  _isWorkflowRun(current) {
    return applicationAdmission._isWorkflowRun(this, current);
  }
  ...
  resolveCompletedResultExport(coordinates) {
    return applicationAdmission.resolveCompletedResultExport(this, coordinates);
  }
  ...
  _validateSemanticEvidence(ref, target) {
    return applicationAdmission._validateSemanticEvidence(this, ref, target);
  }

  _parseSemanticReview(inspection, current, target) {
    return applicationAdmission._parseSemanticReview(this, inspection, current, target);
  }

  async _semanticReview(current, baseView) {
    return applicationAdmission._semanticReview(this, current, baseView);
  }
  ...
  _assertRunMutable(runId) {
    return applicationAdmission._assertRunMutable(this, runId);
  }
  ...
  _admitRecursiveRun(intent, principal, context) {
    return applicationAdmission._admitRecursiveRun(this, intent, principal, context);
  }

  _assertRouteAdmission(intent) {
    return applicationAdmission._assertRouteAdmission(this, intent);
  }
  ...
  _runViewOversizeRefusal(runId, view, observed, shed) {
    return applicationAdmission._runViewOversizeRefusal(this, runId, view, observed, shed);
  }
  ...
  async _workflowRevisionEligibility(current, prepared = {}) {
    return applicationAdmission._workflowRevisionEligibility(this, current, prepared);
  }

  async _validateWorkflowRevisionPlan(current) {
    return applicationAdmission._validateWorkflowRevisionPlan(this, current);
  }
  ...
  _validateContextMapPlan(current) {
    return applicationAdmission._validateContextMapPlan(this, current);
  }

  _validateContextEffectPlan(current) {
    return applicationAdmission._validateContextEffectPlan(this, current);
  }
  ...
  async _resolveContextEvalRunTarget(runId, role) {
    return applicationAdmission._resolveContextEvalRunTarget(this, runId, role);
  }

  async _resolveContextEvalManifestTarget(manifestDigest) {
    return applicationAdmission._resolveContextEvalManifestTarget(this, manifestDigest);
  }
  ...
  async admitContextPackage(rawFields, rawPrincipal, rawContext = null) {
    return applicationAdmission.admitContextPackage(this, rawFields, rawPrincipal, rawContext);
  }
  ...
  _selectedSemanticItem(current, view, section, item, items, episodeContext = null) {
    return applicationAdmission._selectedSemanticItem(this, current, view, section, item, items, episodeContext);
  }
  ...
  async _resolveWorkflowSpec(request, repoRoot) {
    return applicationAdmission._resolveWorkflowSpec(this, request, repoRoot);
  }
  ...
  _normalizeWaveStart(value) {
    return applicationAdmission._normalizeWaveStart(this, value);
  }

  _normalizeWaveProgress(value) {
    return applicationAdmission._normalizeWaveProgress(this, value);
  }

  _normalizeWaveList(value) {
    return applicationAdmission._normalizeWaveList(this, value);
  }

  _normalizeWaveMemberAction(value, label, opts = {}) {
    return applicationAdmission._normalizeWaveMemberAction(this, value, label, opts);
  }
  ...
  _normalizeMessageSend(value) {
    return applicationAdmission._normalizeMessageSend(this, value);
  }

  _normalizeMessageReceipt(value) {
    return applicationAdmission._normalizeMessageReceipt(this, value);
  }

  _normalizeAttentionWatch(value) {
    return applicationAdmission._normalizeAttentionWatch(this, value);
  }

  _normalizeScratchpadRead(value) {
    return applicationAdmission._normalizeScratchpadRead(this, value);
  }

  _normalizeScratchpadAppend(value) {
    return applicationAdmission._normalizeScratchpadAppend(this, value);
  }

  _normalizeScratchpadElevate(value) {
    return applicationAdmission._normalizeScratchpadElevate(this, value);
  }

  _normalizeBoardPost(value) {
    return applicationAdmission._normalizeBoardPost(this, value);
  }

  _normalizeBoardRead(value) {
    return applicationAdmission._normalizeBoardRead(this, value);
  }

  _normalizeKnowledgeSeed(value) {
    return applicationAdmission._normalizeKnowledgeSeed(this, value);
  }
