...
export class Coordinator {
  ...
  // ---- REPL-1 INTEGRATION SEAM (minimal stand-in; repl23-decisions.md dependency note) ----
  admitReplManifest(fields, opts = {}) {
    this.tick();
    ...
    return this._coordination.admitReplManifest(fields, {
      actor: opts.actor ?? 'orchestrator', principalId: opts.principalId ?? opts.actor ?? 'orchestrator',
