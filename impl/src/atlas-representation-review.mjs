...
const ROWS = Object.freeze([
  { rung: 'R1', name: 'ast-cst-structural', status: 'shipped_proposal', paths: ['spec/phase13/atlas-structural-delta.md', 'spec/phase17/atlas-structural-search-rewrite.md', 'spec/phase61/graph-backed-representations.md', 'impl/src/atlas-structural.mjs', 'impl/src/atlas-rewrite.mjs', 'impl/src/atlas-representation-producer.mjs'], limitations: ['no direct rewrite apply', 'syntax evidence is not semantic equivalence'] },
  { rung: 'R2', name: 'symbol-scip-index', status: 'shipped_bounded', paths: ['spec/phase61/graph-backed-representations.md', 'impl/src/atlas-index.mjs', 'impl/src/atlas-representation-producer.mjs'], limitations: ['no live LSP daemon', 'language precision follows parser/index support'] },
  { rung: 'R3', name: 'cpg-cfg-path', status: 'shipped_bounded', paths: ['spec/phase18/atlas-cpg-slice.md', 'spec/phase19/atlas-cpg-delta-impact.md', 'spec/phase20/atlas-cpg-taint.md', 'spec/phase22/atlas-cpg-path-sensitive.md', 'spec/phase54/atlas-cpg-lexical-bindings.md', 'spec/phase61/graph-backed-representations.md', 'impl/src/atlas-cpg.mjs', 'impl/src/atlas-cpg-delta.mjs', 'impl/src/atlas-cpg-taint.mjs', 'impl/src/atlas-representation-producer.mjs'], limitations: ['binding-aware simple identifiers but no closure capture destructuring or catch bindings', 'no full SSA or PDG', 'no aliases heap implicit flow exceptions or interprocedural returns'] },
