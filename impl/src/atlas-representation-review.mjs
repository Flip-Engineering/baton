...
const ROWS = Object.freeze([
  ...
  { rung: 'R3', name: 'cpg-cfg-path', status: 'shipped_bounded', paths: ['spec/phase18/atlas-cpg-slice.md', 'spec/phase19/atlas-cpg-delta-impact.md', 'spec/phase20/atlas-cpg-taint.md', 'spec/phase22/atlas-cpg-path-sensitive.md', 'spec/phase54/atlas-cpg-lexical-bindings.md', 'impl/src/atlas-cpg.mjs', 'impl/src/atlas-cpg-delta.mjs', 'impl/src/atlas-cpg-taint.mjs'], limitations: ['binding-aware simple identifiers but no closure capture destructuring or catch bindings', 'no full SSA or PDG', 'no aliases heap implicit flow exceptions or interprocedural returns'] },
