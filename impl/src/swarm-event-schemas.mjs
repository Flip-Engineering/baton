...
export const SWARM_DRIVER_EVENT_PAYLOAD_SCHEMAS = Object.freeze({
  ...
  'wake.root_delivered': Object.freeze({
    ...
    fields: Object.freeze({
      ...
      runId: STRING('the run a deployment-scoped wake belongs to — absent on a swarm wake', { required: false }),
    ...
    example: Object.freeze({
      seq: 42, wakeClass: 'root_turn_reported', swarmId: null, runId: 'run-root-1',
  ...
  'wake.root_undelivered': Object.freeze({
    ...
    example: Object.freeze({
      seq: 43, wakeClass: 'root_turn_reported', swarmId: null, runId: 'run-root-1',
