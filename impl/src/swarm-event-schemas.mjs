...
export const SWARM_DRIVER_EVENT_PAYLOAD_SCHEMAS = Object.freeze({
  ...
  'wake.root_delivered': Object.freeze({
    summary: Object.freeze('one durable attempt that wrote a root-addressed wake to an operator session through its declared turn-starting channel'),
    fields: Object.freeze({
  ...
  'swarm.root_attention_owed': Object.freeze({
    ...
    fields: Object.freeze({
      ...
      next: { type: 'json', description: 'the act that answers the row, in the attention projection\'s shape', expectation: 'an object naming a command and its identity arguments', example: Object.freeze({ command: 'swarm.view', swarmId: 'swarm-40e643e96fd1edcd' }) },
    }),
    example: Object.freeze({
  ...
  // Issue #594: the preservation lane's two outcome rows — what the runtime published to the
  // deployment's declared shared remote, and what it could not. Driver rows, never
  // caller-submittable and never folded into the swarm state.
