...
function normalizeNode(value, policy, goal) {
  ...
  exactObject(value, ['key', 'objective', 'definitionOfDone', 'deps', 'pathScope', 'risk', 'budget', 'verification', 'routes', 'capabilities', 'effects', ...(hasRequiredEffects ? ['requiredEffects'] : [])]);
