...
// One bounded evidence input for linked-worktree ownership: the durable ownership record and the
// macOS process-cwd observation are both rejected by their consumers when they exceed this size.
