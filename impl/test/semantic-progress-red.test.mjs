...
function repository() {
  ...
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'sp@example.invalid', GIT_COMMITTER_EMAIL: 'sp@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'SP Test', GIT_COMMITTER_NAME: 'SP Test' });
