...
function world(label) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue306@example.invalid', GIT_COMMITTER_EMAIL: 'issue306@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue306', GIT_COMMITTER_NAME: 'Issue306' });
