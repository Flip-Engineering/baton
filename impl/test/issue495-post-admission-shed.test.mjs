...
function repository(t, root) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'bt495@example.invalid', GIT_COMMITTER_EMAIL: 'bt495@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'BT495', GIT_COMMITTER_NAME: 'BT495' });
