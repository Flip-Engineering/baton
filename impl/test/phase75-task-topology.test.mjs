    ...
    tasks: [
      {
        ...
        childrenByRelation: { follow_up: 0, oracle: 1, preserved_resume: 0, recovery: 0, review: 0 },
      },
      {
        schemaVersion: 1, taskId: 'oracle', runId: 'run-a', relation: 'oracle',
        parentTaskId: 'follow', depth: 2, ancestors: ['root', 'follow'], childCount: 0,
        childrenByRelation: { follow_up: 0, oracle: 0, preserved_resume: 0, recovery: 0, review: 0 },
      },
      {
      ...
      },
      {
        ...
        childrenByRelation: { follow_up: 1, oracle: 0, preserved_resume: 0, recovery: 0, review: 1 },
      },
    ],
  });
