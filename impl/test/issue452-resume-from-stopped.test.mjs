...
function fixture(t) {
  ...
  mkdirSync(repo);
  git(repo, ['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue 452', GIT_COMMITTER_NAME: 'Issue 452' });
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue452@example.invalid', GIT_COMMITTER_EMAIL: 'issue452@example.invalid' });
