...
function world(label) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue314l3@example.invalid', GIT_COMMITTER_EMAIL: 'issue314l3@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue314l3', GIT_COMMITTER_NAME: 'Issue314l3' });
