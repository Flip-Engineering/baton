...
const REROUTE_TOTALS = Object.freeze({ logAppend: 36, mapEvent: 16, coordRecord: 6, coordination: 145 });
...
test('RO2: every observation_port delegate keeps the member name, parameter list, and hands over the recorder', () => {
  ...
  assert.equal(delegated.length, 142, `expected the 142 moved delegates in the map, found ${delegated.length}`);
