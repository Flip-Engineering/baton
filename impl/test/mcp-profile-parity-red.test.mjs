...
test('RG-02 RED: application tools/list is the served ordinary table and includes every pre-spread-uncovered sibling (stage: application-tools-count-49)', async () => {
  ...
  assert.equal(names.length, 44 + uncovered.length + 3 + 2 + 2,
    'application tools/list count ties to composition: 36 + 14 + 3 wakes + 2 message + 2 pair + 1 seed + 1 scratchpad + 1 seed = 58 (stage: application-count-composition)');
