...
function world(label) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue478@example.invalid', GIT_COMMITTER_EMAIL: 'issue478@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue478', GIT_COMMITTER_NAME: 'Issue478' });
