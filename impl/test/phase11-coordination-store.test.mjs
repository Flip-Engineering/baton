...
test('CK1: append failure is fatal and leaves event/task projections unchanged', () => {
  ...
  assert.deepEqual(store.snapshot(), { tasks: [], runs: [], artifacts: [], reuseDecisions: [], evidence: [], scratch: { facts: [], claims: [], reads: [] }, knowledge: { nodes: [], edges: [], reads: [], contamination: [] }, lastSeq: 0 });
});
