...
function world(label) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue306r@example.invalid', GIT_COMMITTER_EMAIL: 'issue306r@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue306r', GIT_COMMITTER_NAME: 'Issue306r' });
