...
function gitRepo(label) {
  ...
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue475@example.invalid', GIT_COMMITTER_EMAIL: 'issue475@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue 475', GIT_COMMITTER_NAME: 'Issue 475' });
