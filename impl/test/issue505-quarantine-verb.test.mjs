...
function world(label) {
  ...
  git(['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue505@example.invalid', GIT_COMMITTER_EMAIL: 'issue505@example.invalid' });
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue505', GIT_COMMITTER_NAME: 'Issue505' });
