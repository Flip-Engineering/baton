...
const principal = (overrides = {}) => ({
  ...
  capabilities: ['observe', 'control', 'approve', 'emergency_stop', 'adopt_result'], repoIds: ['repo-a'],
  ...overrides,
});
...
test('UA5/WN: authenticated Run commands are thin mappings to one application command bus', async () => {
  ...
  assert.equal(applicationCalls[3].args.timeoutMs, 30_000, 'Web forwards the exact journaled wait timeout');
