...
import { flipAnnounce, flipFace, flipHumanLine, flipLine, flipStatus, flipStatusPrefix } from '../src/brand.mjs';
...
test('ONE function derives the closed status set from the projection classes', () => {
  ...
  // seat reading a wake row and an operator reading the stderr channel see one vocabulary.
