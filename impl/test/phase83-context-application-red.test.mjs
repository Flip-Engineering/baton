...
test('CA83-1: Context extends the five-operation registry without adding a command or tool family', () => {
  ...
  assert.deepEqual(Object.keys(APPLICATION_SEMANTIC_REGISTRY.actions)
    ...
    'context_chunk', 'context_coverage', 'context_map', 'context_reduce', 'context_search',
  ]);
