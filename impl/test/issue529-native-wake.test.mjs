...
function fixture(t) {
  ...
  mkdirSync(repo);
  git(repo, ['init', '-q']);
  Object.assign(process.env, { GIT_AUTHOR_NAME: 'Issue 529', GIT_COMMITTER_NAME: 'Issue 529' });
  Object.assign(process.env, { GIT_AUTHOR_EMAIL: 'issue529@example.invalid', GIT_COMMITTER_EMAIL: 'issue529@example.invalid' });
