...
Governing clarification: [laws are a minimal set of inviolable behavioral prohibitions](operator-minimal-law-scope.md) guiding implementation agents. This review is evidence for selecting that small set, not a proposal to formalize the entire application design. Every earlier candidate must pass this additional minimality test.
