...
//   node docs/bend2/examples/arch-replay-basis.mjs --run           print and record the RESULT lines
//   node docs/bend2/examples/arch-replay-basis.mjs --compare       compare expect/reference/prototype
//
...
const REFERENCE = join(HERE, 'arch-replay-basis.reference.txt');
const PROTOTYPE = join(HERE, 'arch-replay-basis.prototype.txt');
