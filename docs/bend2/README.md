# docs/bend2 — the Bend2 evaluation (issue #539)

The authority for this directory is [MANDATE.md](MANDATE.md): evaluate rewriting Baton in Bend2 and
produce what is needed to decide. The work is design, review and audit; `impl/src` is not modified
under this issue, and every document here lands on the `bend2-rewrite` branch.
...
Each document below lands as its work item completes:
