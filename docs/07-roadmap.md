...
4. Build the common Context Program and Scratch Bench as the context-computation layer for dynamic
   ...
   checkout is added. Authenticated resident attach/discovery/steer/interrupt and deeper recursive
   composition remain next, followed by direct-vs-context-vs-RLM evaluation.
