...
const LANES = Object.freeze({
  ...
  'waiting-vocabulary': Object.freeze({
    ...
    anchors: [
      ...
      'capacity_ceiling (new durable event task.dispatch_deferred at the coordinator.mjs:2891 ceiling',
      ...
      'keys !blocked && !waiting at wave-driver.mjs:556. The stall-marker strip: delete view.waitingOn',
  ...
  'harvest-accessor': Object.freeze({
    ...
    anchors: [
      ...
      'is the RECORDED task.sessionContext.baseSha (coordinator.mjs:3589-3604), rev-parse parent is an',
  ...
  'nested-orchestration': Object.freeze({
    ...
    anchors: [
      ...
      'connection profile at spawn — WebSessionStore.issue (web-auth.mjs:128) capabilities [observe,',
      ...
      '(runtime-isolation.mjs:76-80 delete list); the fail-closed generation binding (sessions.revoke +',
  ...
  'tight-cell': Object.freeze({
    ...
    anchors: [
      ...
      'aggregate is KERNEL WORK (application.mjs:7393-7430 derives from projection.nodes[0] today):',
