...
const MEMBERS = Object.freeze([
  Object.freeze({
    ...
    objective: [
      salt,
      'You are the DRAFTER in a 2-agent baton workflow producing an agentic-experience (AX)',
      'report. Research is DONE and committed at',
      `${relativeRoot}/research-notes.md (9 grounded frictions — READ IT FIRST).`,
