...
const MEMBERS = Object.freeze([
  Object.freeze({
    ...
    objective: [
      ...
      `and committed at ${relativeRoot}/report-draft.md (126 lines — READ IT FIRST). Your ONLY`,
      'job: post the draft as scratchpad note entries, one per section, at most 1400 bytes',
      'each: SCRATCHPAD_WRITE: {"entry":{"kind":"note","text":"<section text>"},',
      ...
      'no file writes, no further work, no waiting.',
      FENCE, OVERSIZE,
    ].join(' '),
  }),
  Object.freeze({
