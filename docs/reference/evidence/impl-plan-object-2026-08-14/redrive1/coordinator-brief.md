# COORDINATOR BRIEF — impl-plan-object wave

One row works under you: row-plan-object (its brief names the contract: orchestrator-plan-object-red). You receive
...
3. Write verify-notes.md (this dir): VERDICT (sound / needs-fold with blockers), the measured
   counts, anything not green and why. Line 1: IMPL_PLAN_OBJECT-VERIFY v1. [attempt:] line verbatim
