...
`docs/reference/evidence/phase-grammar-2026-08-14/**`. row-impl-compiler owns
...
Deliverable note: `docs/reference/evidence/phase-grammar-2026-08-14/impl-interpreter-notes.md`
