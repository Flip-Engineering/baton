...
sentence, composed per initialize from `this.coordination.contextPackHead('orchestrator-
briefing')` (the handler already holds the store, G7a): `Briefing pack <packId> minted at
