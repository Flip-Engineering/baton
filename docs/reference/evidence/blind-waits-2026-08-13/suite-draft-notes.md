...
- **row-suite-164 · attempt `08d0dac7-8ad0-4e7c-a13e-9d7a3bb855bc`** — the red-first suite for the folded
  #164 blind-waits contract (v2). Attempt echo law (judgment-call interpretation, see §J): the attempt
  id and row id appear in the first five lines of BOTH deliverables.
