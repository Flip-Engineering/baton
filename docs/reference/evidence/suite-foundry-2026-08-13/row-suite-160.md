# ROW BRIEF — row-suite-160: the red-first suite for the folded #160 contract
...
`docs/reference/evidence/error-actionability-2026-08-13/contract-fold.md` (v1.1 — its red-first acceptance section is
...
Deliverables (edit ONLY these): `impl/test/error-actionability-red.test.mjs` ·
`docs/reference/evidence/error-actionability-2026-08-13/suite-draft-notes.md` (the row inventory + stage table + the
