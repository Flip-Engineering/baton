# COORDINATOR BRIEF — impl-result-accessor wave

One row works under you: row-result-accessor (its brief names the contract: harvest-accessor-red). You receive
...
3. Write verify-notes.md (this dir): VERDICT (sound / needs-fold with blockers), the measured
   counts, anything not green and why. Line 1: IMPL_RESULT_ACCESSOR-VERIFY v1. [attempt:] line verbatim
