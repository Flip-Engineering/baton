...
const brief = createBrief({
  goal: `Adversarially review current commit 1a99abb and the CK9 repairs since c8a272e against spec/phase11/coordination-knowledge.md and docs/26-full-system-goal.md. Inspect impl/src/coordinator.mjs, impl/src/coordination-store.mjs, and the focused phase11 tests. Write ${TARGET} with exact headings "## Verdict", "## Crash-window matrix", "## Remaining major findings", and "## Required next actions". Try to falsify pre-effect intent ordering, bounded post-effect ambiguity, restart closure, accepted question/approval single-consumer behavior, refinement abort/replay, the complete paired publication authority verifier, adapter/PID cleanup, integration Git safety, and claims that CK9 is green. Distinguish this deterministic gate from still-missing product features.`,
  constraints: [
    `Edit only ${TARGET}.`,
