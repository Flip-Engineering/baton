...
try {
  ...
  await workflow.stop('Recover the interrupted Phase 85 dogfood Run and reap exact ownership.');
...
if (![1, 3].includes(stopped?.stop?.receipt?.schemaVersion)
  ...
  throw new Error('recovered Phase 85 deployment did not prove zero ownership');
}
