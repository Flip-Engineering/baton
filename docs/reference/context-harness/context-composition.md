...
Internal baton specs grounding the design (absolute paths): `$HOME/Development/Experiments/baton/spec/capability-plane.md` (ACI envelope §3, cards §5, reverify §6), `$HOME/Development/Experiments/baton/docs/10-interaction-model.md` (three topologies, two channels), `$HOME/Development/Experiments/baton/spec/communication-channel.md` (brief §3, digest §6, ask §4), `$HOME/Development/Experiments/baton/docs/09-revision-log.md` (§D4 provenance-typed digests, C1/C5 trust), `$HOME/Development/Experiments/baton/docs/05-telemetry-steering.md` (digest levels §3, orchestrator-context-scarcity principle), `$HOME/Development/Experiments/baton/docs/08-shared-memory-and-pm.md` (three memory tempos, BoK), `$HOME/Development/Experiments/baton/spec/adapter-contract.md` (per-harness goal-pin / inject / compaction mechanics).
