...
- **Phase 85 — addressed lineage and recursive synthesis underway:**
  ...
  states, both `recovery_terminalized` causes, and zero workers on close. The latest counted full run
  is green at 2,107/2,107. Baton itself produced two reviewed exact
  ...
  zero remaining workers. Generic Plan proposal/approval/dispatch and reduce effects remain closed;
  map-specific settlement authority still must be generalized rather than duplicated. The accepted-artifact variant,
