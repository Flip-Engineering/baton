...
- Scratch and causal knowledge primitives ship. Cairn Rungs 0–2 scorecard, verified RouteStats,
  ...
  and deliberately performs no provider effect. The latest counted complete suite is green at
  2,104/2,104. Baton dogfood retained exact Codex high/xhigh Candidates and reaped both process
